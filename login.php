...
<div class="wrapping d-flex flex-column py-5" style="min-height: 620px">
    <div class="reg-block container align-middle my-auto py-4 px-4">
        ...
        <?php endif; ?>
        <form method="post" action="actions/log.php">
            <div>
                <div class="mb-3">
            ...
            <div class="modal-footer d-flex justify-content-between">
                <button type="submit" class="btn btn-primary btn-log-in btn-sign-up">Войти</button>
                <a class="reg" href="registration.php">Нет аккаунта?</a>
            </div>
        </form>
    </div>
</div>
